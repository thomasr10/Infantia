    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (in_array('ROLE_PARENT', $roles)) {
                ...
                $representative->setUserId($user);
                $representative->setAdress($form->get('adress')->getData());
                $representative->setPostalCode($form->get('postal_code')->getData());
                $representative->setCity($form->get('city')->getData());
            ...
            return $this->redirectToRoute('app_mail_new_user', ['email' => $user->getEmail()], Response::HTTP_SEE_OTHER);
        }
